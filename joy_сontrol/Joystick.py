...
class Joystick:
    ...
    def __init__(self):
        ...
        self.joystick = [None, None, None, None] # Массив хрнения джойстиков. Порядок храннения: PS4, cobra, xBox, Logitech
        for i in range(4):
...
if __name__ == '__main__':
    ...
    x, y, z, yaw = joy.joyhandler(x, y, z, yaw)
